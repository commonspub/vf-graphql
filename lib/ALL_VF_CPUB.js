...
"""
union AccountingScope = User | Organisation | Person | Organization | Community | Collection
...
"""
Only used for workaround mentioned in readme
"""
scalar ExternalType
...
type Intent {
  ...
  """
  provider: Agent
  # provider: User   # WIP untill we will implement agent
